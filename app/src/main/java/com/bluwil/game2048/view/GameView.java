package com.bluwil.game2048.view;
...
import com.bluwil.game2048.activity.Game;
import com.bluwil.game2048.bean.GameItem;
import com.bluwil.game2048.config.Config;
...
public class GameView extends GridLayout implements OnTouchListener {
    ...
    private void judgeDirection(int offsetX,int offsetY){
        ...
        }else if (Math.abs(offsetY)>2*Math.abs(offsetX)){
            if (offsetY>0){
                swipeDown();
            }else {
                swipeUp();
